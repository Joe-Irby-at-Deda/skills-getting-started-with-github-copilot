...
activities = {
    ...
    "Soccer Practice": {
        "description": "Team soccer drills and scrimmages for all skill levels",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Swim Team": {
        "description": "Competitive swim training and lap practice",
    ...
    "Music Ensemble": {
        "description": "Rehearse instrumental and vocal pieces for school concerts",
